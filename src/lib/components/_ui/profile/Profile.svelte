...
{#if $fetchedProfile}
	<main class="min-h-screen dark:bg-[#16161D]">
		...
		<div class="mx-auto max-w-7xl px-4 pb-12 md:px-6">
			<div
				class="tooltip relative h-48 rounded-t-xl bg-gradient-to-br from-fuchsia-600 to-rose-500 hover:opacity-80"
			>
				...
				<div class="tooltip tooltipinfo absolute top-0 ml-2 text-white opacity-80">
					Coming soon...
				</div>
			</div>
			<div class="rounded-b-xl bg-[#111116]">
					...
					<div class="">
						...
						<div class="flex items-start justify-between gap-2 py-3">
							<div class="flex flex-col gap-1 pl-36 sm:pl-44">
								...
								<span class="italic text-[#706C6C]"
									>{$fetchedProfile.address.substring(0, 5)}...{$fetchedProfile.address.substring(
										29,
										34
									)}</span
								>
							...
							<div class="tooltip">
								<button
									class="rounded-[10px]  border border-transparent bg-gradient-to-r from-blue-500 to-blue-600 py-1.5 px-6 text-lg font-medium text-white opacity-70"
									disabled
								>
									Edit
									<span class="hidden sm:inline">profile</span>
								</button>
								<div class="tooltip tooltipinfo absolute mt-2 ml-2 text-white opacity-80">
									Coming soon...
								</div>
							</div>
						</div>
				...
				<div class="flex items-center gap-4 px-4 pt-12 sm:px-10">
					...
					<div class="tooltip">
						<button
							class=" tooltip rounded-[10px] border border-transparent bg-transparent py-1.5 px-6 text-lg font-medium text-[#535557] "
							disabled
						>
							Marketplace Items
						</button>
						<div class="tooltip tooltipinfo absolute ml-10 opacity-80">Coming soon...</div>
					</div>
				</div>
				<div
					class="grid grid-cols-1 gap-4 px-4 py-8 sm:grid-cols-2 sm:px-10 md:gap-6 lg:grid-cols-4"
				>
